...
function Exercise(props: Props) {
  return (
    <div>
      <h1 className="text-red-500 bg-blue-100" style={styleHeader}>This is a header</h1>
<p className="para">This is a paragraph</p>
<a href="#" >This is a link</a>
<form>
 
  <h2 className="font-bold">This is a form</h2>
  <label>
    
    <p className="para"> Etrer your name:</p>
